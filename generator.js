...
class Tile {
	constructor(x,y) {
		...
		this.select = function() {
			...
			infoDiv.innerHTML = "<p>X: " + this.x + "</p>" +
								"<p>Y: " + this.y + "</p>" +
								"<p>Walls: " + JSON.stringify(this.walls) + "</p>" +
								"<p>Edge: " + this.edge + "</p>" +
								"<p>Visited: " + this.visited + "</p>" +
								"<p>g/h/f - Cost: " + this.gCost + ", " + this.hCost + ", " + this.fCost + "</p>";
...
solveButton.onclick = function() {alert("Do it yourself!")}
